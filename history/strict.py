...
def start_monitoring():
    ...
    while monitoring:
        ...
        time.sleep(1)  # Add a 1-second delay for accurate timing
...
strict_mode_label.grid(row=5, column=0, columnspan=2, pady=5)

tk.Button(root, text="Toggle Strict Mode", command=toggle_strict_mode).grid(row=6, column=0, columnspan=2, pady=10)
